...
export function buildMaintainerPrompt(): string {
  return [
    ...
    "You are not user-facing. You are invoked only by project_context_search, project_context_update, and project_context_finalize.",
    "",
    "Responsibilities:",
    ...
    "",
    "Rules:",
    "- Never call project_context_prepare, project_context_search, project_context_update, or project_context_finalize. These tools are for the main agent only.",
    ...
    `- Only edit ${DEFAULT_CONTEXT_DIR}/** when an update or finalize job requires context maintenance.`,
